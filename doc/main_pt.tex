...
%
% Introdução                  em       include_intro_en
% Revisão bibliográfica       em       include_revis_pt
% Ferramentas computacionais  em       include_comput_pt
% Resultados e discussão      divididos
%                                em       include_resul_comput_pt
%                                em       include_resul_experi_pt
%                                em       include_resul_models_pt
% Conclusão e cronograma      em       include_final_pt
% Anexo (tabelas)             em       include_extra_pt
%
